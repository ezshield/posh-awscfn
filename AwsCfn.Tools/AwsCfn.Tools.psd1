#
# Module manifest for module 'AwsCfn.Tools'
#
...
Description = 'Various tools and utilities to support working with the AwsCfn module for defining and applying AWS CloudFormation (CFN) templates.'
